  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function showMapTileBounds() {
        ...
        var tiles = Microsoft.Maps.SpatialMath.Tiles.getTilesInBounds(
          map.getBounds(),
          14
        );
        ...
        for (var i = 0; i < tiles.length; i++) {
          ...
          var the_g ="POLYGON((" +poly.geometry.bounds[1] +" " +poly.geometry.bounds[0] +", " +poly.geometry.bounds[3] +" " +poly.geometry.bounds[0] +", " +poly.geometry.bounds[3] +" " +poly.geometry.bounds[2] +", " +poly.geometry.bounds[1] +" " +poly.geometry.bounds[2] +", " +poly.geometry.bounds[1] +" " +poly.geometry.bounds[0] +"))";
